...
class LogoutLoading extends LogoutState {
  LogoutLoading(this.body, this.headers, this.extra);
...
class LogoutSuccess extends LogoutState {
  LogoutSuccess(this.body, this.headers, this.data, this.extra);
...
class LogoutFailed extends LogoutState {
  LogoutFailed(this.body, this.headers, this.failure, this.extra);
