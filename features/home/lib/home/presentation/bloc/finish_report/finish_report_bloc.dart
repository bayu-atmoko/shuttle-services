...
part 'finish_report_event.dart';
part 'finish_report_state.dart';

class FinishReportBloc extends Bloc<FinishReportEvent, FinishReportState> {
  final ListReportUseCase useCase;

  FinishReportBloc({
    required this.useCase,
  }) : super(NewReportInitial()) {
    on<FetchFinishReport>((event, emit) async {
