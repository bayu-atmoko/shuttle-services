...
@immutable
abstract class FinishReportState extends Equatable {
  void when({
  ...
  Widget builder({
    ...
    Widget Function(FinishReportState state)? onStateBuilder,
  }) {
    final state = this;
...
class NewReportInitial extends FinishReportState {
  @override
  List<Object?> get props => [];
}

class NewReportLoading extends FinishReportState {
...
class NewReportSuccess extends FinishReportState {
...
class NewReportFailed extends FinishReportState {
