...
@immutable
abstract class CancelReportState extends Equatable {
  void when({
  ...
  Widget builder({
    ...
    Widget Function(CancelReportState state)? onStateBuilder,
  }) {
    final state = this;
...
class NewReportInitial extends CancelReportState {
  @override
  List<Object?> get props => [];
}

class NewReportLoading extends CancelReportState {
...
class NewReportSuccess extends CancelReportState {
...
class NewReportFailed extends CancelReportState {
