...
part 'assigned_report_event.dart';
part 'assigned_report_state.dart';

class AssignedReportBloc
    extends Bloc<AssignedReportEvent, AssignedReportState> {
  final ListReportUseCase useCase;

  AssignedReportBloc({
    required this.useCase,
  }) : super(NewReportInitial()) {
    on<FetchAssignedReport>((event, emit) async {
