...
@immutable
abstract class CleanedReportState extends Equatable {
  void when({
  ...
  Widget builder({
    ...
    Widget Function(CleanedReportState state)? onStateBuilder,
  }) {
    final state = this;
...
class NewReportInitial extends CleanedReportState {
  @override
  List<Object?> get props => [];
}

class NewReportLoading extends CleanedReportState {
...
class NewReportSuccess extends CleanedReportState {
...
class NewReportFailed extends CleanedReportState {
