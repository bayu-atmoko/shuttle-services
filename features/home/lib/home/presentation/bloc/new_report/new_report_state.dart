...
@immutable
abstract class NewReportState extends Equatable {
  void when({
  ...
  Widget builder({
    ...
    Widget Function(NewReportState state)? onStateBuilder,
  }) {
    final state = this;
...
class NewReportInitial extends NewReportState {
  @override
  List<Object?> get props => [];
}

class NewReportLoading extends NewReportState {
...
class NewReportSuccess extends NewReportState {
...
class NewReportFailed extends NewReportState {
