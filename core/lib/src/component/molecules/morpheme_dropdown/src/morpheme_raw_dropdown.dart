...
const Duration _kMorphemeRawDropdownMenuDuration = Duration(milliseconds: 300);
...
///
/// Used by [MorphemeRawDropdownButton.selectedItemBuilder].
typedef MorphemeRawDropdownButtonBuilder = List<Widget> Function(
    BuildContext context);

class _MorphemeRawDropdownMenuPainter extends CustomPainter {
  _MorphemeRawDropdownMenuPainter({
    this.color,
    this.elevation,
    this.selectedIndex,
    this.borderRadius,
  ...
  @override
  bool shouldRepaint(_MorphemeRawDropdownMenuPainter oldPainter) {
...
class _DropdownMenuItemButton<T> extends StatefulWidget {
  ...
  final _MorphemeRawDropdownRoute<T> route;
...
class _DropdownMenuItemButtonState<T>
  ...
  void _handleOnTap() {
    ...
    Navigator.pop(
      context,
      _MorphemeRawDropdownRouteResult<T>(dropdownMenuItem.value),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    final last = widget.route.items.length - 1 == widget.itemIndex;
...
class _MorphemeRawDropdownMenu<T> extends StatefulWidget {
  const _MorphemeRawDropdownMenu({
    super.key,
    this.padding,
    required this.route,
    required this.buttonRect,
  ...
  @override
  _MorphemeRawDropdownMenuState<T> createState() =>
      _MorphemeRawDropdownMenuState<T>();
}

class _MorphemeRawDropdownMenuState<T>
    extends State<_MorphemeRawDropdownMenu<T>> {
  ...
  Widget build(BuildContext context) {
    ...
    final _MorphemeRawDropdownRoute<T> route = widget.route;
    ...
    return FadeTransition(
      ...
      child: CustomPaint(
        painter: _MorphemeRawDropdownMenuPainter(
          ...
          child: Container(
            ...
            child: Material(
              ...
              child: ScrollConfiguration(
                // MorphemeRawDropdown menus should never overscroll or display an overscroll indicator.
...
class _MorphemeRawDropdownMenuRouteLayout<T> extends SingleChildLayoutDelegate {
  _MorphemeRawDropdownMenuRouteLayout({
    required this.buttonRect,
    required this.route,
  ...
  @override
  bool shouldRelayout(_MorphemeRawDropdownMenuRouteLayout<T> oldDelegate) {
...
@immutable
class _MorphemeRawDropdownRouteResult<T> {
  const _MorphemeRawDropdownRouteResult(this.result);

  final T? result;

  @override
  bool operator ==(Object other) {
    return other is _MorphemeRawDropdownRouteResult<T> &&
        other.result == result;
  }
...
class _MorphemeRawDropdownRoute<T>
    extends PopupRoute<_MorphemeRawDropdownRouteResult<T>> {
  _MorphemeRawDropdownRoute({
    required this.items,
  ...
  @override
  Duration get transitionDuration => _kMorphemeRawDropdownMenuDuration;
  ...
  Widget buildPage(BuildContext context, Animation<double> animation,
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        return _MorphemeRawDropdownRoutePage<T>(
          route: this,
...
class _MorphemeRawDropdownRoutePage<T> extends StatelessWidget {
  const _MorphemeRawDropdownRoutePage({
    super.key,
    required this.route,
    required this.constraints,
    this.items,
  ...
  Widget build(BuildContext context) {
    ...
    // MorphemeRawDropdownButton.itemHeight is specified or MorphemeRawDropdownButton.itemHeight is null
    ...
    final Widget menu = _MorphemeRawDropdownMenu<T>(
      route: route,
      ...
      child: Builder(
        builder: (BuildContext context) {
          return CustomSingleChildLayout(
            delegate: _MorphemeRawDropdownMenuRouteLayout<T>(
              buttonRect: buttonRect,
              route: route,
...
// This widget enables _MorphemeRawDropdownRoute to look up the sizes of
// each menu item. These sizes are used to compute the offset of the selected
// item so that _MorphemeRawDropdownRoutePage can align the vertical center of the
...
// The container widget for a menu item created by a [MorphemeRawDropdownButton]. It
// provides the default configuration for [DropdownMenuItem]s, as well as a
// [MorphemeRawDropdownButton]'s hint and disabledHint widgets.
...
/// An inherited widget that causes any descendant [MorphemeRawDropdownButton]
/// widgets to not include their regular underline.
///
/// This is used by [DataTable] to remove the underline from any
/// [MorphemeRawDropdownButton] widgets placed within material data tables, as
/// required by the Material Design specification.
class MorphemeRawDropdownButtonHideUnderline extends InheritedWidget {
  /// Creates a [MorphemeRawDropdownButtonHideUnderline]. A non-null [child] must
  /// be given.
  const MorphemeRawDropdownButtonHideUnderline({
    super.key,
    required super.child,
  });

  /// Returns whether the underline of [MorphemeRawDropdownButton] widgets should
  /// be hidden.
  static bool at(BuildContext context) {
    return context.dependOnInheritedWidgetOfExactType<
            MorphemeRawDropdownButtonHideUnderline>() !=
        null;
  }

  @override
  bool updateShouldNotify(MorphemeRawDropdownButtonHideUnderline oldWidget) =>
      false;
}
...
///
/// ## Updating to [MorphemeRawDropdownMenu]
///
/// There is a Material 3 version of this component,
/// [MorphemeRawDropdownMenu] that is preferred for applications that are configured
/// for Material 3 (see [ThemeData.useMaterial3]).
/// The [MorphemeRawDropdownMenu] widget's visuals
/// are a little bit different, see the Material 3 spec at
/// <https://m3.material.io/components/menus/guidelines> for
/// more details.
///
/// The [MorphemeRawDropdownMenu] widget's API is also slightly different.
/// To update from [MorphemeRawDropdownButton] to [MorphemeRawDropdownMenu], you will
/// need to make the following changes:
///
/// 1. Instead of using [MorphemeRawDropdownButton.items], which
/// takes a list of [DropdownMenuItem]s, use
/// [MorphemeRawDropdownMenu.dropdownMenuEntries], which
/// takes a list of [MorphemeRawDropdownMenuEntry]'s.
///
/// 2. Instead of using [MorphemeRawDropdownButton.onChanged],
/// use [MorphemeRawDropdownMenu.onSelected], which is also
/// a callback that is called when the user selects an entry.
///
/// 3. In [MorphemeRawDropdownMenu] it is not required to track
/// the current selection in your app's state.
/// So, instead of tracking the current selection in
/// the [MorphemeRawDropdownButton.value] property, you can set the
/// [MorphemeRawDropdownMenu.initialSelection] property to the
/// item that should be selected before there is any user action.
///
/// 4. You may also need to make changes to the styling of the
/// [MorphemeRawDropdownMenu], see the properties in the [MorphemeRawDropdownMenu]
/// constructor for more details.
///
/// See the sample below for an example of migrating
/// from [MorphemeRawDropdownButton] to [MorphemeRawDropdownMenu].
///
/// ## Using [MorphemeRawDropdownButton]
...
///
/// {@tool dartpad}
/// This sample shows a [MorphemeRawDropdownButton] with a large arrow icon,
...
///
/// {@tool dartpad}
/// This sample shows how you would rewrite the above [MorphemeRawDropdownButton]
/// to use the [MorphemeRawDropdownMenu].
///
...
/// See also:
///
///  * [MorphemeRawDropdownButtonFormField], which integrates with the [Form] widget.
///  * [DropdownMenuItem], the class used to represent the [items].
///  * [MorphemeRawDropdownButtonHideUnderline], which prevents its descendant dropdown buttons
///    from displaying their underlines.
///  * [ElevatedButton], [TextButton], ordinary buttons that trigger a single action.
///  * <https://material.io/design/components/menus.html#dropdown-menu>
class MorphemeRawDropdownButton<T> extends StatefulWidget {
  ...
  MorphemeRawDropdownButton({
    ...
    // MorphemeRawDropdownButtonFormField.
  })  : assert(
          items == null ||
              items.isEmpty ||
              value == null ||
              items.where((DropdownMenuItem<T> item) {
                  ...
                  1,
          "There should be exactly one item with [MorphemeRawDropdownButton]'s value: "
          '$value. \n'
  ...
  MorphemeRawDropdownButton._formField({
    super.key,
    required this.items,
    this.selectedItemBuilder,
    this.value,
    ...
    required bool isFocused,
          ...
          items == null ||
              ...
              items.where((DropdownMenuItem<T> item) {
                  ...
                  1,
          "There should be exactly one item with [MorphemeRawDropdownButtonFormField]'s value: "
          '$value. \n'
          'Either zero or 2 or more [DropdownMenuItem]s were detected '
          'with the same value',
        ),
  ...
  ///
  /// If the [onChanged] callback is null or the list of [MorphemeRawDropdownButton.items]
  /// is null then the dropdown button will be disabled, i.e. its arrow will be
  /// displayed in grey and it will not respond to input. A disabled button
  /// will display the [MorphemeRawDropdownButton.disabledHint] widget if it is non-null.
  /// If [MorphemeRawDropdownButton.disabledHint] is also null but [MorphemeRawDropdownButton.hint] is
  /// non-null, [MorphemeRawDropdownButton.hint] will instead be displayed.
  /// {@endtemplate}
  ...
  ///
  /// {@tool dartpad}
  /// This sample shows a `MorphemeRawDropdownButton` with a button with [Text] that
  ...
  final MorphemeRawDropdownButtonBuilder? selectedItemBuilder;
  ...
  ///
  /// {@tool dartpad}
  /// This sample shows a `MorphemeRawDropdownButton` with a dropdown button text style
  ...
  ///
  /// As the padding increases, the size of the [MorphemeRawDropdownButton] will also
  ...
  @override
  State<MorphemeRawDropdownButton<T>> createState() =>
      _MorphemeRawDropdownButtonState<T>();
}

class _MorphemeRawDropdownButtonState<T>
    extends State<MorphemeRawDropdownButton<T>> with WidgetsBindingObserver {
  int? _selectedIndex;
  _MorphemeRawDropdownRoute<T>? _dropdownRoute;
  ...
  void dispose() {
    ...
    _removeMorphemeRawDropdownRoute();
    _internalNode?.dispose();
    super.dispose();
  }

  void _removeMorphemeRawDropdownRoute() {
  ...
  @override
  void didUpdateWidget(MorphemeRawDropdownButton<T> oldWidget) {
  ...
  void _handleTap() {
      ...
      for (int index = 0; index < widget.items!.length; index += 1)
        _MenuItem<T>(
          ...
          onLayout: (Size size) {
            ...
            // that performLayout was called on a _MorphemeRawDropdownRoute that has not
            // left the widget tree but is already on its way out.
            //
            // Since onLayout is used primarily to collect the desired heights
            // of each menu item before laying them out, not having the _MorphemeRawDropdownRoute
    ...
    final Rect itemRect =
        Offset(position.dx, position.dy + itemBox.size.height + 8) &
            itemBox.size;
    _dropdownRoute = _MorphemeRawDropdownRoute<T>(
      items: menuItems,
    ...
    navigator
        .push(_dropdownRoute!)
        .then<void>((_MorphemeRawDropdownRouteResult<T>? newValue) {
      _removeMorphemeRawDropdownRoute();
  ...
  Widget build(BuildContext context) {
        ...
        child: Row(
          ...
          children: <Widget>[
            if (widget.isExpanded)
              ...
              innerItemsWidget,
            const Padding(
              padding: EdgeInsets.only(right: MorphemeSizes.s12),
              child: MorphemeImageAsset(
                MorphemeIcons.icArrowBottom,
                width: MorphemeSizes.s24,
                height: MorphemeSizes.s24,
    ...
    if (!MorphemeRawDropdownButtonHideUnderline.at(context)) {
      final double bottom =
...
/// A [FormField] that contains a [MorphemeRawDropdownButton].
///
/// This is a convenience widget that wraps a [MorphemeRawDropdownButton] widget in a
/// [FormField].
///
...
/// See also:
///
///  * [MorphemeRawDropdownButton], which is the underlying text field without the [Form]
///    integration.
class MorphemeRawDropdownButtonFormField<T> extends FormField<T> {
  /// Creates a [MorphemeRawDropdownButton] widget that is a [FormField], wrapped in an
  /// [InputDecorator].
  ///
  ...
  MorphemeRawDropdownButtonFormField({
    ...
    MorphemeRawDropdownButtonBuilder? selectedItemBuilder,
    T? value,
    Widget? hint,
    Widget? disabledHint,
    required this.onChanged,
    ...
    // MorphemeRawDropdownButton.
        ...
        super(
          ...
          builder: (FormFieldState<T> field) {
            final _MorphemeRawDropdownButtonFormFieldState<T> state =
                field as _MorphemeRawDropdownButtonFormFieldState<T>;
            ...
            bool isHintOrDisabledHintAvailable() {
              final bool isMorphemeRawDropdownDisabled =
                  onChanged == null || (items == null || items.isEmpty);
              if (isMorphemeRawDropdownDisabled) {
            ...
            return Focus(
              ...
              child: Builder(builder: (BuildContext context) {
                return MorphemeRawDropdownButtonHideUnderline(
                  child: MorphemeRawDropdownButton<T>._formField(
                    items: items,
  ...
  FormFieldState<T> createState() =>
      _MorphemeRawDropdownButtonFormFieldState<T>();
}

class _MorphemeRawDropdownButtonFormFieldState<T> extends FormFieldState<T> {
  @override
  void didChange(T? value) {
    super.didChange(value);
    final MorphemeRawDropdownButtonFormField<T> dropdownButtonFormField =
        widget as MorphemeRawDropdownButtonFormField<T>;
    assert(dropdownButtonFormField.onChanged != null);
    dropdownButtonFormField.onChanged!(value);
  }

  @override
  void didUpdateWidget(MorphemeRawDropdownButtonFormField<T> oldWidget) {
    super.didUpdateWidget(oldWidget);
